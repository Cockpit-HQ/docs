...
The *Collection page item* field is a feature rich complex field type. When using this field type you can specify the collection to use. Later, when providing content for the field, you can choose the desired page from your list of [Pages](/addons/pages/) of type *Collection*.
...
::: danger Caution!
If you do not see the Layout field type in the list of field types of your Cockpit installation, you're probably missing the [Layout](/addons/layout/) addon. Please make sure to install it.
:::
...
Use a *Layout* field whenever you want to provide data in a layout for websites or applications. This feature is especially useful when it comes to creating and editing data for [Pages](/addons/pages/).

Further information on layout components and configuration options can bee found in the [Layout](/addons/layout/) section.
...
The *Page link / url* field displays a component, that allows you to link a page from your list of [Pages](/addons/pages/).
...
```json:no-line-numbers
"wysiwyg-example": "<p>Hello <strong>World</strong>!</p>\n<p>&nbsp;</p>\n<p>This is my first <em>wysiwig </em>field content.</p>\n<p>&nbsp;</p>\n<p>Greetings.</p>"
```