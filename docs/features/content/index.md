...
A content model consists of the fields you define, with each field belonging to one of Cockpit's [Field types](/features/basics/#field-types). Depending on the fields configured you can than create items containing the required data.

Whenever you want to manage content, navigate to [https://cockpit.example.com/content](https://cockpit.example.com/content).
